...
if os.path.exists(SAVE_PATH):
    ...
    df = YahooDownloader(config.START_DATE,#'2000-01-01',
                        ...
                        ticker_list = config.DOW_30_TICKER).fetch_data()#DOW_30_TICKER)道琼斯30只股票
    df.to_csv(SAVE_PATH)
...
validation_window = 25 # validation_window is the number of days to do validation and trading
